...
public class GT_Container_ComputerCube extends GT_ContainerMetaTile_Machine {
    ...
    public GT_Container_ComputerCube(InventoryPlayer aInventoryPlayer, GT_TileEntity_ComputerCube aTileEntity) {
        super(aInventoryPlayer, aTileEntity.getBaseMetaTileEntity());
    }
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        ...
        if (mID != ((GT_TileEntity_ComputerCube)mTileEntity).mMode)
            return null;
        ...
        if (tSlot != null) {
            if (aSlotIndex == 0) {
                ...
                aPlayer.openGui(MainMod.instance, 1, mTileEntity.getWorld(), mTileEntity.getXCoord(), mTileEntity.getYCoord(), mTileEntity.getZCoord());
            } else {
                        ...
                        if (aShifthold == 1) {
                            ...
                            if (tStack == null) {
                                ...
                                for (int i = 1; i < GT_TileEntity_ComputerCube.sReactorList.size(); i++) {
                                    if (Item.getIdFromItem(GT_TileEntity_ComputerCube.sReactorList.get(i-1)) == Item.getIdFromItem(tStack.getItem())) {
    ...
    public void detectAndSendChanges() {
        ...
        if (mTileEntity.getWorld().isRemote)
            return;
